...
```bash
LD_LIBRARY_PATH=/lib64/slurm:$LD_LIBRARY_PATH $HOME/barn/spank-plugins/plugins/tests/metadata/build/test $HOME/barn/spank-plugins/plugins/spank_qrmi/build/spank_qrmi.so
```
